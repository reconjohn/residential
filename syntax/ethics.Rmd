...
* How to address: Community solar
* Final notes]
...
```{r echo=FALSE}
knitr::include_graphics("./stat_files/figure-html/unnamed-chunk-22-1.png", dpi= 120)
knitr::include_graphics("./stat_files/figure-html/unnamed-chunk-24-1.png", dpi= 120)
...
.larger[* Utilitarianism: more efficient to use resources to maximize the global benefits thus, current distribution of PV gets along with this ethical principle casuing the opposition of the virtual ethic, social justice. 

* Responsive cohesion: by taking advantage of a process of adjustment, adaptation, and compromising the different objectives and challenges of the both principles. 

* Prudentialist ethic: address the issue by encouraging decentralized and diversified energy systems to enhance the community resilience. After all, community solar will address the ethical judgement.]     
...
.larger[* Spatial diversification (decentralization): the need of the polycentric governance as it is critically related to socio-economic actors. Spatial diversity in a portfolio can reduce investment risks.
